...
public class HeroShip extends Fighter {
    ...
    private void setDeathAnimation() {
        ...
        Array<TextureRegion> hitFrame = new Array<TextureRegion>();
        hitFrame.add(new TextureRegion((world.getPlayerAtlas().findRegion("PlanetBlaster_Damage"))));
        hitFrame.add(new TextureRegion((world.getPlayerAtlas().findRegion("PlanetBlaster"))));
        hitFrame.add(new TextureRegion((world.getPlayerAtlas().findRegion("PlanetBlaster_Damage"))));
        hitFrame.add(new TextureRegion((world.getPlayerAtlas().findRegion("PlanetBlaster"))));
        hitFrame.add(new TextureRegion((world.getPlayerAtlas().findRegion("PlanetBlaster_Damage"))));
        hitFrame.add(new TextureRegion((world.getPlayerAtlas().findRegion("PlanetBlaster"))));
        ...
        hitAnimate = new Animation(.1f, hitFrame, Animation.PlayMode.NORMAL);
        ...
        if (isDead) {
            ...
            if (invincible) {
                timeInvincible += delta;
                    Sprite temp = sprite;
                    temp.setPosition(sprite.getX(),sprite.getY());
                    temp.setRegion(hitAnimate.getKeyFrame(timeInvincible));
